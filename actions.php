    ...
    <main role="main">
      ...
      <div class="container">
        <div class="row mt50">
          ...
          <div class="col-md-4">
            <img  id="drag1" src="img/Desert.jpg" class="img-fluid" alt="">
          </div>
          <div class="col-md-4">
            <img id="drag2" src="img/Jellyfish.jpg" class="img-fluid"   alt="">
          </div>
          <div class="col-md-4">
            <img id="drag3" src="img/Koala.jpg" class="img-fluid"   alt="">
          </div>
        </div>
        <div class="row mt50">
          <div class="col-md-12">
          ...
          <div class="col-md-8">
            <div id="gallery">
              <img src="img/Koala.jpg" width="200" alt="">
              <img src="img/Desert.jpg" width="200" alt="">
              <img src="img/Jellyfish.jpg" width="200" alt="">
            </div>
          </div>
